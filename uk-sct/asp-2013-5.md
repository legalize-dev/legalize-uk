...
- (2) An authorisation under the Controlled Activities Regulations is subject to approval of a qualifying abstraction by the Scottish Ministers under this Part, so far as relevant in relation to the activities to which the authorisation relates (except where the authorisation exempts the abstraction under section 7(1)).
