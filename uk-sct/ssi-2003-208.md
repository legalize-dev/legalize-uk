...
identifier: "ssi-2003-208"
country: "uk"
rank: "scottish-statutory-instrument"
publication_date: "2003-03-20"
last_updated: "2003-03-20"
status: "in_force"
source: "https://www.legislation.gov.uk/ssi/2003/208"
department: "Queen's Printer for Scotland"
jurisdiction: "uk-sct"
pdf_url: "https://www.legislation.gov.uk/ssi/2003/208/pdfs/ssi_20030208_en.pdf"
...
- “the 2000 Regulations” means the Pollution Prevention and Control (Scotland) Regulations 2000[^f00004];
...
- “landfill permit” means the permit which is required by the 2000 Regulations for the carrying out of the disposal of waste in a landfill;
...
- “operator” has the meaning given by regulation 2(1) of the 2000 Regulations;
...
- “waste” means controlled waste within the meaning of section 75(4) of the Environmental Protection Act 1990[^f00006];
...
- other expressions which are also used in Directive [99/31/EC](https://www.legislation.gov.uk/european/directive/1999/0031) on the landfill of waste[^f00007] shall have the same meaning as in that Directive.
...
- (i) non-hazardous dredging sludges alongside the bank or towpath of a small waterway from which they have been dredged where that activity falls within the exemption from waste management licensing in paragraph 25 of Schedule 3 to the Waste Management Licensing Regulations 1994[^f00008];
...
A planning permission under the Town and Country Planning (Scotland) Act 1997[^f00009] may be granted for a landfill only if the requirements of paragraph 1(1) of Schedule 3 to these Regulations have been taken into consideration.
...
- (a) at the beginning there is inserted “(a)”; and

- (b) at the end there is inserted–

> > (b) The disposal of waste in any other landfill to which the 2003 Regulations apply.
...
- (b) ensuring that the financial provision or its equivalent required by regulation 4(3)(b) of the 2000 Regulations[^f00010] is maintained until the permit is surrendered in accordance with those Regulations;
...
- (a) it is listed on the Hazardous Waste List of the European Waste Catalogue[^f00011] or has similar characteristics to those so listed; and
...
- (3) In this paragraph “nature protection zone” means land which has been notified under section 28 of the Wildlife and Countryside Act 1981[^f00012] or a European site within the meaning of regulation 10(1) of the Conservation (Natural Habitats, &c.) Regulations 1994[^f00013].
...
- (b) in a landfill for non-hazardous waste: K ≤ 1.0 x 10−9 metre/second: thickness ≥ 1 metre;

- (c) in a landfill for inert waste: K ≤ 1.0 x 10−7 metre/second: thickness ≥ 1 metre.
...
- (8) The requirements of sub-paragraphs (3) to (7) may be reduced to an appropriate extent if on the basis of an assessment of environmental risks, having regard in particular to Directive [80/68/EEC](https://www.legislation.gov.uk/european/directive/1980/0068)[^f00014]–
...
|  | Operational phase | After-care phase[^f01002] |
| --- | --- | --- |
| Notes to Table 1 | Notes to Table 1 | Notes to Table 1 |
| (1) Longer intervals may be allowed if the evaluation of data indicates that they would be equally effective. For leachates, the conductivity must always be measured at least once a year. | (1) Longer intervals may be allowed if the evaluation of data indicates that they would be equally effective. For leachates, the conductivity must always be measured at least once a year. | (1) Longer intervals may be allowed if the evaluation of data indicates that they would be equally effective. For leachates, the conductivity must always be measured at least once a year. |
| (2) These do not apply where leachate collection is not required under paragraph 2(1)(c) of Schedule 3. | (2) These do not apply where leachate collection is not required under paragraph 2(1)(c) of Schedule 3. | (2) These do not apply where leachate collection is not required under paragraph 2(1)(c) of Schedule 3. |
| (3) The frequency of sampling may be adapted on the basis of the morphology of the landfill waste (in tumulus, buried, etc) (but only if SEPA considers that the conditions of the landfill permit should allow for it). | (3) The frequency of sampling may be adapted on the basis of the morphology of the landfill waste (in tumulus, buried, etc) (but only if SEPA considers that the conditions of the landfill permit should allow for it). | (3) The frequency of sampling may be adapted on the basis of the morphology of the landfill waste (in tumulus, buried, etc) (but only if SEPA considers that the conditions of the landfill permit should allow for it). |
...
| Leachate volume [^f01001] | Monthly [^f01000], [^f01002] | Every six months |
| Leachate composition [^f01001][^f01003] | Quarterly[^f01000] | Every six months |
| Volume and composition of surface water [^f01004] | Quarterly [^f01000] | Every six months |
| Potential gas emissions and atmospheric Pressure[^f01005] (CH₄, CO₂, O₂, H₂S, H₂ etc) | Monthly [^f01000], [^f01006] | Every six months [^f01007] |
...
| (3) When a trigger level is reached (see paragraph 5), verification is necessary by repeating the sampling. When the level has been confirmed, a contingency plan set out in the landfill permit conditions must be followed. | (3) When a trigger level is reached (see paragraph 5), verification is necessary by repeating the sampling. When the level has been confirmed, a contingency plan set out in the landfill permit conditions must be followed. | (3) When a trigger level is reached (see paragraph 5), verification is necessary by repeating the sampling. When the level has been confirmed, a contingency plan set out in the landfill permit conditions must be followed. |
| Level of groundwater | Every six months[^f01008] | Every six months[^f01008] |
| Groundwater composition | Site-specific frequency[^f01009], [^f01010] | Site-specific frequency[^f01009],[^f01010] |
...
| --- | --- | --- |
| Note to Table 3 | Note to Table 3 | Note to Table 3 |
| (1) Data for the status plan of the concerned landfill: surface occupied by waste, volume and composition of waste, methods of depositing, time and duration of depositing, calculation of the remaining capacity still available at the landfill. | (1) Data for the status plan of the concerned landfill: surface occupied by waste, volume and composition of waste, methods of depositing, time and duration of depositing, calculation of the remaining capacity still available at the landfill. | (1) Data for the status plan of the concerned landfill: surface occupied by waste, volume and composition of waste, methods of depositing, time and duration of depositing, calculation of the remaining capacity still available at the landfill. |
| Structure and composition of landfill body[^f01011] | Yearly |  |
...
- (1) Subject to sub-paragraph (2), this regulation shall apply to a landfill if–
...
In regulation 2(2)(a) (contents of transfer notes) of the Environmental Protection (Duty of Care) Regulations 1991 after “identify the waste to which it relates” there is inserted “by reference to the appropriate six-digit codes in the European Waste Catalogue.[^f00017]”.
...
| Section 5.2 Part A | The period specified in the notice served on the operator under paragraph 1(9) of Schedule 5 to the 2003 Regulations. |
| --- | --- |
...
An application for a landfill permit under regulation 7 relating to an installation where an activity falling within Part A of Section 5.2 in Part 1 of Schedule 1 is carried out shall contain the following additional information–
...
- (1) the Waste Management Licensing Regulations 1994[^f00018] are amended as follows.
...
These Regulations set out a pollution control regime for landfills for the purpose of implementing Council Directive [99/31/EC](https://www.legislation.gov.uk/european/directive/1999/0031) on the landfill of waste (“the Landfill Directive”) in Scotland. Landfills have previously been subject to either the Waste Management Licensing Regulations 1994 or the Pollution Prevention and Control (Scotland) Regulations 2000 (“the 2000 Regulations”) (which in turn implemented Council Directive [96/61/EC](https://www.legislation.gov.uk/european/directive/1996/0061) concerning integrated pollution prevention and control (“the IPPC Directive”)).
...
[^f00006]: [1990 c. 43](https://www.legislation.gov.uk/ukpga/1990/43) and see regulation 7A of S.I. [1992/588](https://www.legislation.gov.uk/uksi/1992/588) as amended by S.I. [1993/566](https://www.legislation.gov.uk/uksi/1993/566), regulations 1 and 24(8) of, and paragraph 9 to, Schedule 4 of S.I. [1994/1056](https://www.legislation.gov.uk/uksi/1994/1056) and the amendments made to section 75(2) for the purposes of these Regulations by paragraph 88 of Schedule 22 to the Environment Act [1995 (c. 25)](https://www.legislation.gov.uk/ukpga/1995/25) by [S.S.I. 206](https://www.legislation.gov.uk/ssi/2003/206).

[^f00007]: O.J. No. L 182, 16.7.1999, p.1; the Directive was designated by [S.S.I. 185](https://www.legislation.gov.uk/ssi/2003/185) as a relevant directive for the purposes of paragraph 20(2)(c) of Schedule 1 to the 1999 Act.
