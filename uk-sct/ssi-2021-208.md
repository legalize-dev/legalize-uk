...
In regulation 5C[^f00003] (testing following arrival in Scotland: general)—
...
In regulation 5E(1)[^f00004] (testing following arrival in Scotland: obligation to provide information)—
...
In regulation 5F[^f00005] (testing following arrival in Scotland: requirement to undertake tests)—
...
For regulation 5G(1)[^f00006] (testing following arrival in Scotland: requirement to self-isolate on failure to undertake a test) substitute—
...
In regulation 5H[^f00007] (testing following arrival in Scotland: consequences of test results) before paragraph (1) insert—
...
In regulation 6(1)[^f00008] (requirement for travellers to stay in specified premises)—
...
In regulation 6A(1)[^f00009] (requirement for certain travellers to possess managed self-isolation package)—
...
In regulation 6B(1)[^f00010] (requirement for certain travellers to stay in managed accommodation)—
...
In schedule 2 (passenger notices) of the Health Protection (Coronavirus, Public Health Information for Passengers Travelling to Scotland) Regulations 2020[^f00012]—
...
MICHAEL MATHESON — A member of the Scottish Government — At 1.03 p.m. on 14th May 2021
