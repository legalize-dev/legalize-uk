...
- (f) obtain any disclosure record required in respect of the application ; and
...
- (13) An application under paragraph(12) shall contain the information, declarations, certificate or application, disclosure request and disclosure record, undertakings and consents mentioned in paragraph(1), except that required by sub-paragraphs1(d) and 3 of Part1A of Schedule2.
