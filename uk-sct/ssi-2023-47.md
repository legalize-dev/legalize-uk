...
- (1) Except where paragraph (4) applies, the Upper Tribunal, when deciding a case appealed from the First-tier Tribunal, must consist of—
...
- (4) The Upper Tribunal, when exercising functions under section 1(3A) or (3BA) of the Lands Tribunal Act 1949[^f00008], shall consist of three members of the Upper Tribunal.
