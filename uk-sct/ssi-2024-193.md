...
These Regulations may be cited as the Scottish Pubs Code Regulations 2024 and come into force on 7 October 2024.
...
- “*market rent*” means the estimated rent which it would be reasonable to pay in respect of the occupation of the pub under a tenancy, assuming that— the hypothetical tenancy is not subject to— a product tie, or a service tie, the hypothetical tenancy is entered into— on the date the estimate of the rent is being carried out, in an arm’s length transaction, after proper marketing, between parties who are all acting knowledgeably, prudently and willingly, and the pub will continue to be a pub,
...
- “*product tie*” means a contractual obligation which— requires that a product to be sold in a pub must be supplied by— the landlord of the pub, or a person nominated by the landlord, and is not a stocking requirement (as defined in this regulation),
...
- “*service tie*” means a contractual obligation which requires that the tenant of a pub receives a service, other than insurance, from— the landlord of the pub, or a person nominated by the landlord,

- “*stocking requirement*” means a contractual obligation which— requires that some of the beer or cider (or both) that is to be sold in the pub is produced by the landlord, does not require the tenant to procure that beer or cider from a particular supplier, and neither prevents the tenant from, nor penalises the tenant for, selling in the pub beer or cider that is produced by a person other than the landlord (although a contract term may impose restrictions on such sales),
