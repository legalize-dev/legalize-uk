...
Section 27 of the Environment Act 1995 (c. 25) (SEPA's power to obtain information about land for the purposes mentioned in that section) applies where SEPA considers that it requires information relating to any land for the purpose of the exercise of any of its functions under this Part, subject to the modification that the notice served by SEPA under subsection (1) of that section must specify the land, the function and this Act.
