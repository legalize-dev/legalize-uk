...
- (11) The authorised provider may discharge the liability for payment of the benefits under the pension policy by payment of a lump sum representing their capital value if such a lump sum would be defined in regulation 2(Z)(b) of the Registered Pension Schemes (Authorised Payments) Regulations 2009[^f00016].
...
- (8) In regulation 16, wherever regulation 12(5), (6) or (9) is referred to, the reference shall include a reference to that regulation as modified by this regulation in relation to pension credits.
