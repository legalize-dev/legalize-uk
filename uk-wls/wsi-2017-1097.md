...
An annual return which is submitted by a service provider who is registered to provide a domiciliary support service must contain the additional information specified in the Schedule in relation to each of the places in relation to which the service is provided.
