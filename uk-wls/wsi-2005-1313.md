...
- (b) notify the local authority (if that authority is not the adoption agency) and Local Health Board or Primary Care Trust (England) in whose area the prospective adopter resides in writing of the proposed placement;

- (c) notify the local education authority in whose area the prospective adopter resides in writing of the proposed placement and information about the child’s educational history and whether the child has been or is likely to be assessed for special educational needs under the Education Act 1996.
