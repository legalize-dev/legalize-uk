...
- (a) a full-time course of one or two academic years' duration;

- (b) a part-time course which is ordinarily possible to complete in no more than twice the period ordinarily required to complete its one or two academic year full-time equivalent; or
