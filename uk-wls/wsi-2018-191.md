...
$$A × ( d Y − d P ) d Y$Where—A is the amount of grant or maintenance loan payable;dY is the number of days in the academic year in question;dP is the number of days during the year that the eligible student is a prisoner.$
...
$$A × ( d Y − d A b s ) d Y$Where—A is the amount of grant or maintenance loan payable;dY is the number of days in the academic year in question;dAbs is the number of days during the year that the eligible student is absent from the present course.$
...
$$A × ( p p Y − p p T ) p p Y$Where—A is the amount of grant or maintenance loan payable;ppY is the number of payment periods in the academic year in question;ppT is the number of payment periods in the year beginning after the eligible student's period of eligibility has ended or has been terminated.$
