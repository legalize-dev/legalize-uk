...
>       (a) has as the first place at which passengers can embark a place which is within the European Union ,
>       (b) has as the last place at which passengers who embarked in a member State can disembark a place which is within the the European Union , and
>       (c) does not include a stop at a place which is not within the European Union and at which passengers can embark or passengers who embarked in a member State can disembark.
...
>     (4) A place is within the the European Union if it is within any member State.
