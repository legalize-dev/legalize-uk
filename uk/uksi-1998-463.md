...
- Newcastle disease (avian paramyxovirus type 1) viruses which are— uncharacterised; or have an intracerebral pathogenicity index in one-day-old chicks of 0.4 or more, when not less than 10 million 50% egg infectious doses (EID₅₀) are administered to each bird in the test
