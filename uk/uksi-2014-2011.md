...
- (2) Where the allocation process, or such part of it as applies to equivalent applications, is to be re-run further to or paragraph (1B), the delivery body must ensure that the re-run process includes any pending application which is determined as a qualifying application.
