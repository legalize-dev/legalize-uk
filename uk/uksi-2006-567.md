...
| The scheme makes a stand-alone lump sum payment to a member where—condition A in article 25(2) of the Taxation of Pension Schemes (Transitional Provisions) Order 2006[^f00004] is met and the payment is more than 7.5% of the standard lifetime allowance for the tax year in which the sum is paid; orcondition B or C in that article is met. | The name, address, date of birth and national insurance number of the member;the amount and date of payment of the lump sum; andthe reference number, if any, given by the Commissioners under the Registered Pension Schemes (Enhanced Lifetime Allowance) Regulations 2006. |
