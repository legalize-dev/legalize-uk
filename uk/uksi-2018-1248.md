...
- (a) meets the criteria which apply to be approved as an authorised economic operator as provided by regulation 93(1)(c) and (d), as if reference to suitability to be an authorised economic operator were a reference to suitability to be an authorised declarant;
