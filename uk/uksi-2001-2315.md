---
title: "The Air Quality Limit Values Regulations 2001"
identifier: "uksi-2001-2315"
country: "uk"
rank: "statutory-instrument"
publication_date: "2001-06-25"
last_updated: "2001-06-25"
status: "in_force"
source: "https://www.legislation.gov.uk/uksi/2001/2315"
department: "Queen's Printer of Acts of Parliament"
pdf_url: "https://www.legislation.gov.uk/uksi/2001/2315/pdfs/uksi_20012315_en.pdf"
subjects: ["UnitedKingdomStatutoryInstrument"]
long_title: "These Regulations are made in the implementation of Council Directive 96/62/EC on ambient air quality assessment and management, and Council Directive 99/30/EC relating to limit values for sulphur dioxide, nitrogen dioxide and oxides of nitrogen, particulate matter and lead (‘the relevant pollutants’) in ambient air. The Regulations apply to England, except for regulation 10 which applies to the United Kingdom."
...
- (8) Where the relevant pollutant is sulphur dioxide, the zone may be designated under this paragraph[^f00003] if the limit values are exceeded in the zone owing to concentrations of sulphur dioxide in ambient air due to natural sources.

- (9) Where the relevant pollutant is PM₁₀, the zone may be designated—

- (a) under this sub-paragraph[^f00004] if due to natural events concentations of PM₁₀ in the ambient air are significantly in excess of normal background levels from natural sources;

- (b) under this sub-paragraph[^f00005] if due to the resuspension of particulates following the winter sanding of roads concentrations of PM₁₀ in the ambient air are significantly in excess of normal background levels from natural sources.
...
- (9) For any zone designated under regulation 5(9)(b), the Secretary of State may provide that plans or programmes shall only be required where the limit values are exceeded owing to PM₁₀ levels other than those caused by winter road sanding.
...
- (1) For the purposes of the implementation of any obligations of the United Kingdom under Council Directive [96/62/EC](https://www.legislation.gov.uk/european/directive/1996/0062) on ambient air quality assessment and management[^f00006] and Council Directive [99/30/EC](https://www.legislation.gov.uk/european/directive/1999/0030) relating to limit values for sulphur dioxide, nitrogen dioxide and oxides of nitrogen, particulate matter and lead in ambient air[^f00007]—
...
as the Secretary of State has under section 85(5) of the Environment Act 1995[^f00008] in relation to local authorities in England outside Greater London.
...
- (1) The Air Quality Standards Regulations 1989[^f00009], insofar as they apply to England, are hereby revoked as follows.
...
- (5) From 19th July 2001 until 1st January 2005, if the methods prescribed by these regulations for the assessment of suspended particulate matter are used for the purpose of demonstrating compliance with type=start slip=2001-07-01 time=1187770220973Annex IV type=end slip=2001-07-01 time=1187770220973Directive [80/779/EEC](https://www.legislation.gov.uk/european/directive/1980/0779) of 15th July 1980 on air quality limit values and guide values for suspended particulates[^f00010], the data so collected shall be multiplied by a factor of 1.2.
...
|  | Averaging period | Limit value | Margin of tolerance[^f00011] | Date by which limit value is to be met |
| --- | --- | --- | --- | --- |
...
500 μg/m³ measured over three consecutive hours at locations representative of air quality over at least 100 km² or an entire zone, whichever is the smaller.
...
| --- | --- | --- | --- |
| Upper assessment value | 70% of limit value (140 μg/m³), not to be exceeded more than 18 times in any calendar year | 80% of limit value (32 μg/m³) | 80% of limit value (24 μg/m³) |
| Lower assessment value | 50% of limit value (100 μg/m³), not to be exceeded more than 18 times in any calendar year | 65% of limit value (26 μg/m³) | 65% of limit value (19.5 μg/m³) |

|  | 24-hour average | Annual average |
| --- | --- | --- |
| Upper assessment threshold | 60% of limit value (30 μg/m³), not to be exceeded more than seven times in any calendar year | 70% of limit value (14 μg/m³) |
...
- location of traffic-orientated samplers; for all pollutants, such sampling points should be at least 25 m from the edge of major junctions and at least 4 m from the centre of the nearest traffic lane, for nitrogen dioxide, inlets should be no more than 5 m from the kerbside, for particulate matter and lead, inlets should be sited so as to be representative of air quality near to the building line.
...
| 4,750 –5,999 | 9 | 4 | 2 |
| >6,000 | 10 | 5 | 3 |
|  | For NO₂ and particulate matter: to include at least one urban-background station and one traffic-orientated station |  |  |
...
The accuracy of the measurement is defined as laid down in the ‘ Guide to the Expression of Uncertainty of Measurements ’ (ISO 1993)[^f00012] or in ISO 5725-1 ‘ Accuracy (trueness and precision) of measurement methods and results ’ (ISO 1994)[^f00013]. The percentages in the table are given for individual measurements averaged, over the period considered, by the limit value, for a 95% confidence interval (bias + two times the standard deviation). The accuracy for continuous measurements should be interpreted as being applicable in the region of the appropriate limit value.
...
## SCHEDULE 6 — REFERENCE METHODS FOR ASSESSMENT OF CONCENTRATIONS OF SULPHUR DIOXIDE, NITROGEN DIOXIDE AND OXIDES OF NITROGEN, PARTICULATE MATTER (PM ₁ ₀ AND PM 2 . 5) AND LEAD

## PART I — Reference method for the analysis of sulphur dioxide

ISO/FDIS 10498 (Standard in draft) Ambient air—determination of sulphur dioxide—ultraviolet fluorescence method[^f00014].

## PART II — Reference method for the analysis of nitrogen dioxide and oxides of nitrogen

ISO 7996: 1985 Ambient air—determination of the mass concentrations of nitrogen oxides—chemiluminescence method[^f00015].

## PART IIIA — Reference method for the sampling of lead

The reference method for the sampling of lead will be that described in the Annex to Directive [82/884/EEC](https://www.legislation.gov.uk/european/directive/1982/0884)[^f00016] until such time as the limit value in Schedule 1 to these Regulations is to be met, when the reference method will be that for PM₁₀ specified in Part IV of this Schedule.

## PART IIIB — Reference method for the analysis of lead

ISO 9855: 1993 Ambient air—Determination of the particulate lead content of aerosols collected in filters. Atomic absorption spectroscopy method[^f00017].

## PART IV — Reference method for the sampling and measurement of PM10

The reference method for the sampling and measurement of PM₁₀ will be that described in EN 12341 ‘ Air Quality—Field Test Procedure to Demonstrate Reference Equivalence of Sampling Methods for the PM₁₀ fraction of particulate matter ’[^f00018]. The measurement principle is based on the collection on a filter of the PM₁₀ fraction of ambient particulate matter and the gravimetric mass determination.
...
Michael Meacher — Minister of State — Department for Environment, Food and Rural Affairs — 25th June 2001

## Explanatory note

(This note is not part of the Regulations)

These Regulations are made in the implementation of Council Directive [96/62/EC](https://www.legislation.gov.uk/european/directive/1996/0062) on ambient air quality assessment and management, and Council Directive [99/30/EC](https://www.legislation.gov.uk/european/directive/1999/0030) relating to limit values for sulphur dioxide, nitrogen dioxide and oxides of nitrogen, particulate matter and lead (‘the relevant pollutants’) in ambient air. The Regulations apply to England, except for regulation 10 which applies to the United Kingdom.

Regulation 3 places the Secretary of State under a duty to take the measures necessary to ensure that in each zone in England concentrations of relevant pollutants do not exceed limit values. The limit values for each pollutant, and the date by which they are to be met, are set out in Schedule 1.

Regulation 4 requires that the Secretary of State ensures that ambient air is assessed for each zone. Regulation 5 requires her to classify each zone in relation to each of the relevant pollutants. Regulation 5 together with Schedule 2 provide for the determination of upper and lower assessment thresholds for each relevant pollutant. Regulation 5 sets out the requirements for measurement or other assessment of air quality depending on pollution levels in relation to these thresholds. It also provides for the designation of zones where action programmes are not required in certain circumstances even though limit values for sulphur dioxide or particulates are exceeded.

Regulation 6 places a duty on the Secretary of State to review the classification of zones every five years or in the event of significant changes affecting levels of any of the relevant pollutants.

Regulation 7 requires the Secretary of State to ensure that specified methods are used for assessing air quality for each pollutant in each zone. Schedule 3 sets out how sampling points for the relevant pollutants are to be determined. Schedule 4 sets out criteria for the minimum number of sampling points for fixed measurements to assess compliance with limit values in zones where that is the only source of information, and with limit values for the protection of ecosystems or vegetation in certain other zones. Schedule 5 makes provision for data quality objectives for the required accuracy of assessment methods, and for compilation of the results of air quality assessment. Schedule 6 prescribes references methods for the analysis, sampling or measurement of the relevant pollutants. Regulation 7 places a duty on the Secretary of State to ensure that measuring stations supply data on concentrations of PM2.5 particulate matter.

Regulation 8 requires the Secretary of State to draw up action plans indicating measures to be taken in the short term where there is a risk that limit values for any of the relevant pollutants, or alert thresholds for sulphur dioxide or nitrogen dioxide, will be exceeded. The alert thresholds for sulphur dioxide and nitrogen dioxide are set out in paragraph 1.2 of Part I and paragraph 2.2 of Part II of Schedule 1.

Regulation 9 requires the Secretary of State to draw up lists of zones where the levels of one or more of the relevant pollutants is above the limit value, or between the limit value and any margin of tolerance shown in Schedule 1. For such zones, regulation 9 places a duty on the Secretary of State to draw up a plan or programme, which must contain at least the information set out in Schedule 7 (including the location and origin of the pollution, the responsible authorities and the measures taken to deal with the pollution).

Regulation 10 provides for consultations between Member States of the European Union over likely exceedances of limit values or alert thresholds from pollution arising in another Member State. Regulation 10 further provides for consultation between the Secretary of State and the relevant administration for such matters affecting Scotland, Wales or Northern Ireland.

Regulation 11 extends existing powers, under section 85(5) of the Environment Act 1995, for the Secretary of State to give directions to local authorities for the implementation of any obligations of the United Kingdom under the Community Treaties. Regulation 10 would allow such directions to be given by the Secretary of State to the Mayor of London and local authorities within Greater London for the purposes of the implementation of Council Directives [96/62/EC](https://www.legislation.gov.uk/european/directive/1996/0062) and [99/30/EC](https://www.legislation.gov.uk/european/directive/1999/0030).

Regulation 12 requires the Secretary of State to list zones where levels of the relevant pollutants are below limit values, to ensure that levels of these pollutants are maintained below the limit values, and to endeavour to preserve the best ambient air quality, compatible with sustainable development.
...
2 Control of industrial emissions— a by local authorities by means of ‘ local air pollution control ’ and by the Environment Agency under ‘ integrated pollution control ’ under Part I of the Environmental Protection Act [1990 (c. 43)](https://www.legislation.gov.uk/ukpga/1990/43); b by local authorities and the Environment Agency using their powers under the Pollution Prevention and Control (England and Wales) Regulations 2000 (S.I. [2000/1973](https://www.legislation.gov.uk/uksi/2000/1973)).

3 Control of transport emissions A series of vehicle emission regulations transposing Council Directives impose limits on vehicle emissions including: S.I. [1992/2137](https://www.legislation.gov.uk/uksi/1992/2137) (covering Directives [91/441/EEC](https://www.legislation.gov.uk/european/directive/1991/0441) and [91/542/EEC](https://www.legislation.gov.uk/european/directive/1991/0542)), S.I. [1993/2199](https://www.legislation.gov.uk/uksi/1993/2199) (covering Directive [93/59/EEC](https://www.legislation.gov.uk/european/directive/1993/0059)); S.I. [1995/2210](https://www.legislation.gov.uk/uksi/1995/2210) (covering Directive [94/12/EC](https://www.legislation.gov.uk/european/directive/1994/0012)); S.I. [1997/1544](https://www.legislation.gov.uk/uksi/1997/1544) (covering Directive [96/69/EC](https://www.legislation.gov.uk/european/directive/1996/0069)) and S.I. [2000/3197](https://www.legislation.gov.uk/uksi/2000/3197) (covering Directive [98/69/EC](https://www.legislation.gov.uk/european/directive/1998/0069)). Environmental standards for fuel were set in 1994 (S.I. [1994/2295](https://www.legislation.gov.uk/uksi/1994/2295)) and 1999 (S.I. [1999/3107](https://www.legislation.gov.uk/uksi/1999/3107)). A full account of all the measures through which achievement of limit values will be sought is set out in the ‘ Air Quality Strategy for England, Scotland, Wales and Northern Ireland ’ published by the Department of the Environment, Transport & the Regions, Scottish Executive, National Assembly for Wales and Northern Ireland Assembly, January 2000 (Cm. 4548).
...
[^f00003]: *See* regulation 9(6).

[^f00004]: *See* regulation 9(8).

[^f00005]: *See* regulation 9(9).

[^f00006]: OJ No. L296, 22.11.1996, p. 55.

[^f00007]: OJ No. L163, 29.6.1999, p.41.

[^f00008]: [1995 c. 25](https://www.legislation.gov.uk/ukpga/1995/25); section 85 was amended by the Greater London Authority Act [1999 (c. 29)](https://www.legislation.gov.uk/ukpga/1999/29), section 367.

[^f00009]: S.I. [1989/317](https://www.legislation.gov.uk/uksi/1989/317), amended by S.I. [1995/3146](https://www.legislation.gov.uk/uksi/1995/3146).

[^f00010]: OJ L 229, 30.8.1980, p. 30.

[^f00011]: The figures for margins of tolerance for each of the relevant pollutants given in this Schedule are calculated from those given in Annexes I to IV to Directive [99/30/EC](https://www.legislation.gov.uk/european/directive/1999/0030).

[^f00012]: Copies of these International Standards Organisation publications can be purchased from the British Standards Institution ‘ BSI ’ sales department either by telephone on 020-8996-9001 or by post from the BSI, Standards House, 389 Chiswick High Road, London W4 4AL.

[^f00013]: Copies of these International Standards Organisation publications can be purchased from the British Standards Institution ‘ BSI ’ sales department either by telephone on 020-8996-9001 or by post from the BSI, Standards House, 389 Chiswick High Road, London W4 4AL.

[^f00014]: Copies of these International Standards Organisation publications can be purchased from the British Standards Institution ‘ BSI ’ sales department either by telephone on 020-8996-9001 or by post from the BSI, Standards House, 389 Chiswick High Road, London W4 4AL.
...
[^f00016]: OJ L378, 31.12.1982, p. 15.

[^f00017]: Copies of these International Standards Organisation publications can be purchased from the British Standards Institution ‘ BSI ’ sales department either by telephone on 020-8996-9001 or by post from the BSI, Standards House, 389 Chiswick High Road, London W4 4AL.

[^f00018]: European Standards Institute ‘ CEN ’ publication reference BSEN 12341, obtainable from the British Standards Institute ‘ BSI ’ as for footnote (17) above.
