...
> > (3) Any passport, identity card, family permit, residence card , derivative residence card or permanent residence card which is required to be produced under this regulation as a condition for admission to the United Kingdom (“the required documents”) may, for the same purpose, be required to be produced in a Control Zone.
