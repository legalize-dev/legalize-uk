...
- (2) In carrying out the review the Treasury must, so far as is reasonable, have regard to how the recovery and resolution directive (which is partially implemented by means of articles 2 to 127) is implemented in other EEA states.
