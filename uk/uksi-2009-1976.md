...
- (4) An application for an order under paragraph (1) may be made at any time during the proceedings but may not be made later than 14 days after the date on which the Tribunal sends to the person making the application the decision notice recording the decision which finally disposes of all issues in the proceedings.
