...
Article 402 of the Companies (Northern Ireland) Order 1986 (certain charges void if not registered) shall not apply (if it would otherwise do so) in relation to a security financial collateral arrangement or any charge created or otherwise arising under a security financial collateral arrangement.
