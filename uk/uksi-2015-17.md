...
- (d) an incorporated friendly society (as defined in section 116 of the Friendly Societies Act 1992 ) which has that name; or

- (e) a company to which section 1040 of the Act (companies authorised to register under the Companies Act 2006) applies which has that name.
