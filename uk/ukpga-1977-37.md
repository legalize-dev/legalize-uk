...
- (a) where an application for a European patent (UK) is refused or withdrawn, or the designation of the United Kingdom in the application is withdrawn, after publication of the application but before a question relating to the right to the patent has been referred to the comptroller under subsection (1) above or before proceedings relating to that right have begun before the relevant convention court;
...
- (b) a person who by virtue of section 28A(4) or (5) above or section 64 below is entitled to do an act in relation to the invention without it constituting such an infringement shall, so far as concerns that act, be treated as a person entitled to work the invention.
