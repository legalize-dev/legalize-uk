...
- one by English Nature;

- two by the Great Yarmouth Port and Haven Commissioners;

- one by the National Rivers Authority;
...
- (d) any person to whom the telecommunications code set out in Schedule 2 to the Telecommunications Act 1984 is applied by a licence under section 7 of that Act;
