...
- “*dynamic demand technology*” means any technology which enables—the consumption of electricity, at a particular time, by a device connected to a network, orthe generation of electricity, at a particular time, by an electricity microgenerating system connected to a network,to be controlled or adjusted automatically by reference to, or to matters relating to, the frequency of alternating current on the network at that time;
