...
- (7) Nothing in this article overrides the requirement for an environmental permit under regulation 12(1)(b) of the Environmental Permitting (England and Wales) Regulations 2016[^f00029].
...
The construction of a new railway line from the rail freight terminal (Works No. 2) to connect with the existing Castle Donington branch freight only railway line to the north of Lockington, the general arrangement of which is shown on the regulation 6(2) plan (Document 2.4D), including—
...
- (c) the construction of a railway overbridge to cross Main Street, Lockington and all necessary superstructures and substructures including footings, abutments and wingwalls;
...
- (f) diversion of public footpath L83 as shown on the access and rights of way plans (Document 2.3A).
