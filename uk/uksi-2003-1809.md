...
- (b) in relation to any other EEA State, the national maritime administration maintained by that State for the inspection of ships; and
...
- (2) Where there is clear evidence that a ship has proceeded to sea without having complied with regulation 12(1) or 16(1) the Secretary of State shall, if the next port of call of the ship is a port of another EEA State, inform the competent authority of the State in which the port is situated about the ship and the evidence.
