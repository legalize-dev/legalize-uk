...
- “compulsory ticket area” means any area at a station which a person must not enter or be present in without being able to produce— a valid travel ticket authorising travel on a train arriving at or departing from that area; or a platform ticket authorising their entry to or presence in that area;
...
- “preceding train”, in relation to a train which a person is travelling by, present on or leaving, means any train— the person travelled by, as part of the same journey, before changing to that train; and which was operated by the same operator as that train;
...
- (5) Subject to paragraph (6), a penalty fare charged under paragraph (1) to a person travelling by or present on a train authorises that person to—
...
- (6) Paragraph (5) does not apply where, at the time a penalty fare is charged under paragraph(1), the train is stationary at a station and there is sufficient opportunity for the person charged to leave the train at that station.
...
- (1) Where a penalty fare is charged under regulation 5(1) to a person travelling by, present on, or leaving a train, the amount of that penalty fare is £20 or twice the full single fare applicable, whichever is greater.
...
- (4) Where a person present in or leaving a compulsory ticket area, other than as a result of leaving a train that arrived at that compulsory ticket area, is charged a penalty fare under regulation 5(1), the amount of the penalty fare is—
...
- (1) Where a collector proposes to charge a person a penalty fare under regulation 5(1), that person must, subject to regulation 10(4), provide their name and address when required to do so by the collector.

- (2) Any person who fails to provide their name and address in accordance with paragraph (1) is guilty of an offence and liable on summary conviction to a fine not exceeding level 2 on the standard scale.
...
- (8) Where the relevant Appeal Panel—
...
- (8) Where the relevant Final Appeal Panel—
