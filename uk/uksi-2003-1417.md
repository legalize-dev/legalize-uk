...
- (x) a local authority where it has a statutory charge created under section 22 of the Health and Social Services and Social Security Adjudications Act 1983 on the beneficial interest of an equitable joint tenant in a registered estate and is applying for a restriction in Form MM to be entered in the register of that estate.
...
- (3) A reference in these rules to Forms A to Y and Forms AA to PPQQ (in each case inclusive) is to the standard form of restriction bearing that letter in Schedule 4.
