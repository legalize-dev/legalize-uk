...
$$TFI−QHOηh,ref$Where—*TFI*is the CHP Total Fuel Input for the station specified on the current CHPQA certificate relating to the station at the time the quantity of the carbon price support rate commodity is brought onto, or arrives at, the CHPQA site.*QHO* is the CHP Qualifying Heat Output for the station specified on the current CHPQA certificate relating to the station at the time the quantity of the carbon price support rate commodity is brought onto, or arrives at, the CHPQA site.*ηh,ref*is the reference boiler heat efficiency, taken here to be 81%.$
