...
- (1) The Water Framework Directive (Priority Substances and Classification) Regulations (Northern Ireland) 2011[^f00005] are amended in accordance with paragraphs (2) to (9).

- (2) In regulation 2 (interpretation)—

- (a) for the definition of “biological boundary value” substitute—

> > - “biological boundary value” in respect of biological quality elements means the classification boundaries for ecological status as set out in Annex V of the Water Framework Directive and as agreed following the EU intercalibration exercise[^f00006];
...
> - “shellfish waters” means any water classified under the Surface Waters (Shellfish) (Classification) Regulations (Northern Ireland) 1997[^f00007];
...
The Surface Waters (Fishlife) (Classification) Regulations (Northern Ireland) 1997[^f00008] are revoked.

###### 5

The Surface Waters (Fishlife) (Classification) (Amendment) Regulations (Northern Ireland) 2007[^f00009] are revoked.
