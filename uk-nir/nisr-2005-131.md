...
- “relevant accounts” means –audited accounts for the scheme which are prepared in respect of a period ending with the relevant time;if none are so prepared, the latest such accounts which are available at the relevant time; orif the appropriate person’s opinion is that it is practicable to use them, the latest such accounts which are available on the date the appropriate person signs the Article 127 or Article 162 valuation;
