...
- (8) The Department must calculate the tariff rates each year in accordance with paragraph (7) and publish on or before 1stApril of each year a table of tariffs for the period commencing with 1stApril of that year and ending with 31stMarch of the following year.
