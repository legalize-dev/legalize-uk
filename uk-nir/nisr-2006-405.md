...
Subject to paragraph 22, the claimant is entitled to one, but not both, of the components in paragraphs 23 and 24 if the claimant or the claimant’s partner is entitled to a converted employment and support allowance.
...
- (c) in the benefit week in which the claimant again becomes entitled to housing benefit the relevant person satisfies the requirements of paragraph 27(1) or is entitled to an employment and support allowance which is not income-related;
